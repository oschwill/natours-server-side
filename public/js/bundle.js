...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); // Wenn el existiert springen ein hoch in das parentelement und löschen von dort aus das Child!
...
var showAlert = function showAlert(type, msg) {
  ...
  document.querySelector('body').insertAdjacentHTML('afterbegin', markup); // Lösche den Alert nach 5000ms wieder!
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            (0, _alerts.showAlert)('error', 'Bitte geben Sie alles ein!');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 17:
            (0, _alerts.showAlert)('error', 'Bitte vervollständigen Sie das Formular!!');
...
var validateEmail = function validateEmail(mail) {
  ...
  (0, _alerts.showAlert)('error', 'You have entered an invalid email address!');
  return false;
};
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXp6dSIsImEiOiJjazZzemk3YXQwMmhsM2xxcDE3YXYxejVxIn0.tN27NokhKKrdzxVQZbXofQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/azzu/ck6szmrbx0wp21imfl41upoaw',
    // Zoom via mausscroll deaktivieren
    scrollZoom: false // Longitude, lattitude
  ...
  locations.forEach(function (loc) {
    // Create marker
    var el = document.createElement('div'); // neues div element erstellen
    ...
    new mapboxgl.Popup({
      ...
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend the map bounds to include current location
...
var stripe = Stripe('pk_test_REjJL7JFKqA3jvI7GoYSvVph00bPNTP9eE');
...
// DOM ELEMENTS
var mapBox = document.getElementById('map'); // login form

var loginForm = document.querySelector('.form--login'); // profile User Data Form

var userDataForm = document.querySelector('.form-user-data'); // password User Data Form

var userPassWordForm = document.querySelector('.form-user-password'); // logout Button

var logOutBtn = document.querySelector('.nav__el--logout'); // Booking Button
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault(); // als FormData übergeben, somit können wir auch Dateien übergeben => FormData lässt den type text als auch file zu!
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              document.querySelector('.btn--save-password').textContent = 'Save Password'; // die Passwordfelder clearen
